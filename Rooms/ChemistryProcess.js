...
function finishProcess(theProcess)
{
	...
	if(theProcess == "One")
	{
		...
		if(!processSucess)
		{
			document.getElementById("pOne").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
			revertContent(processStep1, processStep1Clear);
		}
		else{
			document.getElementById("pOne").innerHTML = "Fantastic! Flip the page to continue to the next process.";
			AddEntry("p2");
			processOne = false;	
			processTwo = true;
			saveProcess();
	...
	if(theProcess == "Two")
	{
		...
		for(var g = 0; g < processStep2.length; g++)
		{
			...
			{
				alert(processStep2[g] + " " + processStep2Correct[g] + " " + g);
				processSucess = false;
			}
		}
		if(!processSucess)
		{
			document.getElementById("pTwo").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
			revertContent(processStep2, processStep2Clear);
		}
		else{
			document.getElementById("pTwo").innerHTML = "Fantastic! Flip the page to continue to the next process.";
			AddEntry("p3");
			processTwo = false;	
			processThree = true;
			saveProcess();
	...
	if(theProcess == "Three")
	{
		...
		if(!processSucess)
		{
			document.getElementById("pThree").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
			revertContent(processStep3, processStep3Clear);
		}
		else{
			document.getElementById("pThree").innerHTML = "Fantastic! Flip the page to continue to the next process.";
			AddEntry("p4");
			processThree = false;	
			processFour = true;
			saveProcess();
	...
	if(theProcess == "Four")
	{
		...
		if(!processSucess)
		{
			document.getElementById("pFour").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
			revertContent(processStep4, processStep4Clear);
		}
		else{
			document.getElementById("pFour").innerHTML = "Fantastic! Flip the page to continue to the next process.";
			AddEntry("p5");
			processFour = false;	
			processFive = true;
			saveProcess();
	...
	if(theProcess == "Five")
	{
		...
		if(!processSucess)
		{
			document.getElementById("pFive").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
			revertContent(processStep5, processStep5Clear);
		}
		else{
			document.getElementById("pFive").innerHTML = "Fantastic! Flip the page to continue to the next process.";
			AddEntry("p6");
			processFive = false;	
			processSix = true;
			saveProcess();
	...
	if(theProcess == "Six")
	{
		...
		for(var g = 0; g < length; g++)
		{
			...
			{
				alert(processStep6[g] + " " + processStep6Correct[g]);
				processSucess = false;
			}
		}
		if(!processSucess)
		{
			document.getElementById("pSix").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
			revertContent(processStep6, processStep6Clear);
		}
		else{
			document.getElementById("pSix").innerHTML = "Fantastic! Flip the page to continue to the next process.";
			AddEntry("p7");
			processSix = false;	
			processSeven = true;
			saveProcess();
	...
	if(theProcess == "Seven")
	{
		...
		if(!processSucess)
		{
			document.getElementById("pSeven").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
	...
	if(theProcess == "Eight")
	{
		...
		if(!processSucess)
		{
			document.getElementById("pEight").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
			revertContent(processStep8PartOne, processStep8PartOneClear);
			revertContent(processStep8PartTwo, processStep8PartTwoClear);
		}
		else{
			document.getElementById("pEight").innerHTML = "Fantastic! Flip the page to continue to the next process.";
			AddEntry("p9");
			processEight = false;	
			processNine = true;
			saveProcess();
	...
	if(theProcess == "Nine")
	{
		...
		if(!processSucess)
		{
			document.getElementById("pNine").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
			revertContent(processStep9, processStep9Clear);
		}
		else{
			document.getElementById("pNine").innerHTML = "Fantastic! Flip the page to continue to the next process.";
			AddEntry("p10");
			processNine = false;	
			processTen = true;
			saveProcess();
	...
	if(theProcess == "Ten")
	{
		...
		if(!processSucess)
		{
			document.getElementById("pTen").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
			revertContent(processStep10, processStep10Clear);
		}
		else{
			document.getElementById("pTen").innerHTML = "Fantastic! Flip the page to continue to the next process.";
			AddEntry("p11");
			processTen = false;	
			processEleven = true;
			saveProcess();
	...
	if(theProcess == "Eleven")
	{
		...
		for(var g = 0; g < processStep11.length; g++)
		{
			...
			{
				processSucess = false;
				alert("Index: " + g + "Actual: " + processStep9[g] + "Correct: " +  processStep9Correct[g]);	
			}
		}
		if(!processSucess)
		{
			document.getElementById("pEleven").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
			revertContent(processStep11, processStep11Clear);
		}
		else{
			document.getElementById("pEleven").innerHTML = "Fantastic! Flip the page to continue to the next process.";
			AddEntry("p12");
			processEleven = false;	
			processTwelve = true;
			saveProcess();
	...
	if(theProcess == "Twelve")
	{
		...
		if(!processSucess)
		{
			document.getElementById("pTwelve").innerHTML = "You have made a mistake and have been reverted to the beginning of the process. Please try again.";
