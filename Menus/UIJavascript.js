...
function trash(){
	...
	if(index == -1 && index5 == -1 && stripCursorImage(document.getElementById("game").style.cursor) != "MixingRodVert.png" && stripCursorImage(document.getElementById("game").style.cursor) != "Nails.png")
		document.getElementById("game").style.cursor = "";
	else
		displayMessage("You cannot throw this away!");
}
